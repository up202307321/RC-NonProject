...
const char* states[] = {"START","FLAG","A","C","XOR","FINAL"};
    ...
    while (STOP == FALSE)
    {
        ...
        switch(currentState){
            ...
            case A:
                ...
                else if (byte == 0x07) currentState = C;
        ...
        printf("Byte received: %.2x\n",byte);
        
        //mudar para dois sets
        /*if (byte == 0x7E){
            if(counter == 0){
                counter++;
            }
                ...
                if (msg_counter == 2){
                    ...
                    printf("Received end char. Stop reading from serial port.\n");
                    msg_counter++;
                    counter = 0;
                }
            }
